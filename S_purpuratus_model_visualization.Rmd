...
The plots below show the proportion of larvae having food in their gut in each condition and light regime. This derives from the raw data, not the predictive model.
